...
namespace Task_1 {
    ...
    public partial class StudentDataSet : global::System.Data.DataSet {
        ...
        public partial class StudentsDataTable : global::System.Data.TypedTableBase<StudentsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public StudentsRow AddStudentsRow(string StudentName, System.DateTime BirthDay, string Address, string MobileNumber, int CountryId, int GradeId) {
        ...
        public partial class StudentsRow : global::System.Data.DataRow {
            ...
            public string MobileNumber {
                get {
                    try {
                        return ((string)(this[this.tableStudents.MobileNumberColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'MobileNumber\' in table \'Students\' is DBNull.", e);
                    }
                }
                set {
                    this[this.tableStudents.MobileNumberColumn] = value;
                }
            }
            ...
            public bool IsMobileNumberNull() {
                return this.IsNull(this.tableStudents.MobileNumberColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public void SetMobileNumberNull() {
                this[this.tableStudents.MobileNumberColumn] = global::System.Convert.DBNull;
            }
        }
...
namespace Task_1.StudentDataSetTableAdapters {
    ...
    public partial class StudentsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Students] ([StudentName], [BirthDay], [Address], [MobileNumber" +
                "], [CountryId], [GradeId]) VALUES (@StudentName, @BirthDay, @Address, @MobileNum" +
                "ber, @CountryId, @GradeId)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Students] SET [StudentName] = @StudentName, [BirthDay] = @BirthDay," +
                " [Address] = @Address, [MobileNumber] = @MobileNumber, [CountryId] = @CountryId," +
                " [GradeId] = @GradeId WHERE (([StudentId] = @Original_StudentId))";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = System.Configuration.ConfigurationManager.ConnectionStrings["ApplicationDbContext"].ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT StudentId, StudentName, BirthDay, Address, MobileNumber, CountryId, GradeI" +
                "d FROM dbo.Students";
        ...
        public virtual int Insert(string StudentName, System.DateTime BirthDay, string Address, string MobileNumber, int CountryId, int GradeId) {
            if ((StudentName == null)) {
            ...
            this.Adapter.InsertCommand.Parameters[5].Value = ((int)(GradeId));
        ...
        public virtual int Update(string StudentName, System.DateTime BirthDay, string Address, string MobileNumber, int CountryId, int GradeId, int Original_StudentId) {
            if ((StudentName == null)) {
